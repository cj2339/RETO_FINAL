...
/**
 * JUnit 5 test class that verifies the complete CRUD workflow of
 * DBImplementationClient. It checks correct insertion, retrieval,
 * update and deletion of Client records, as well as proper handling
 * of non‑existent and invalid operations.
 *
 * @author Santiago
 */
